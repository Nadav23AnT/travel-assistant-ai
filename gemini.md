...
## 🤖 Gemini Code - Development Assistant Role

### Full-Stack Development Responsibilities

Gemini Code is your full-stack development partner, responsible for:
...
When you request a feature or bug fix, Gemini Code will:
...
**You stay in control** - Gemini Code will ask clarifying questions when needed and always explain what's being built and why.
...
- **Parallel agent execution** - Run multiple Gemini Code agents on different features simultaneously
...
To run multiple Gemini Code agents simultaneously:

```bash
# Terminal 1 - Working on chat feature
cd .trees/feature-chat
# Start Gemini Code agent here

# Terminal 2 - Working on dashboard
cd .trees/feature-dashboard
# Start another Gemini Code agent here
...
When running multiple Gemini Code agents:
