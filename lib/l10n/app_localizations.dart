...
abstract class AppLocalizations {
  ...
  /// Generic trip name fallback
  ///
  /// In en, this message translates to:
  /// **'Your Trip'**
  String get yourTrip;

  /// Title for journal ready notification
  ///
  /// In en, this message translates to:
  /// **'Your Trip Journal is Ready!'**
  String get journalReadyTitle;

  /// Description for journal ready notification
  ///
  /// In en, this message translates to:
  /// **'We\'ve created {count} journal entries from your {tripName} adventure.'**
  ...
  /// Label indicating journal was auto-generated
  ///
  /// In en, this message translates to:
  /// **'Auto-generated from your activities'**
  String get journalAutoGenerated;

  /// Loading message while generating journals
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @errorTokenLimit.
  ///
  /// In en, this message translates to:
  /// **'You have reached your daily AI usage limit.'**
  String get errorTokenLimit;
