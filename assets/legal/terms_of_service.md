...
- **AI-Powered Travel Assistant**: Chat-based AI for travel recommendations and advice
- **Budget Management**: Set and monitor travel budgets
- **Travel Journaling**: Document your travel experiences
- **Currency Conversion**: Real-time exchange rate information
- **Trip Insights**: Analytics and summaries of your travel activities
- **Daily Travel Tips**: Personalized suggestions and recommendations

Some features may require a paid subscription (see Section 9: Premium Features).
...
- **No Guarantees**: We do not guarantee the accuracy, completeness, reliability, or suitability of AI-generated content
- **User Responsibility**: You are solely responsible for decisions made based on AI recommendations

### 4.2 Travel and Financial Decisions

**You agree that:**
- You will independently verify all important travel information (visa requirements, health advisories, booking confirmations, etc.)
- You will not rely solely on AI for critical financial or safety decisions
- You understand that travel conditions can change rapidly (weather, political situations, health emergencies)
- You are responsible for checking official sources for travel warnings and requirements

### 4.3 No Liability for AI Errors

We are not liable for any losses or damages resulting from:
- Inaccurate or incomplete AI responses
- Reliance on AI-generated travel recommendations
- Errors in trip planning or budgeting suggestions
- Missed opportunities or travel disruptions based on AI advice
...
You agree to:
- Provide truthful and accurate information when creating your account
- Keep your profile information up to date
- Not impersonate others or misrepresent your identity

### 5.3 Responsible Data Entry
You are responsible for:
- The accuracy of expense data, trip details, and other information you enter
- Any consequences resulting from incorrect or incomplete data entry
- Backing up important information (we recommend exporting data regularly)
...
### 6.3 Abuse and Exploitation
- Send spam, phishing attempts, or malicious content through the App
- Upload viruses, malware, or harmful code
- Scrape or harvest data from the App using automated tools
- Use the App to harass, abuse, or harm others

### 6.4 Fraudulent Activity
- Provide false information to obtain services or subscriptions
- Engage in payment fraud or chargebacks without valid reason
...
### 7.3 User Content
You retain ownership of content you create in the App (trip details, expenses, journal entries, etc.). By using the App, you grant us a license to store, process, and display your content solely for the purpose of providing our services.

We do not claim ownership of your personal travel data.
...
- The accuracy of expense calculations or budget projections
- The correctness of currency conversion rates (rates are provided by third parties)
- The reliability of AI-generated travel recommendations
- That the App will be free from bugs, errors, or security vulnerabilities
- That data will never be lost (you should maintain backups)

### 8.3 Third-Party Services
We integrate with third-party services (currency APIs, AI providers, authentication services). We are not responsible for:
...
### 9.1 No Liability for Financial Losses
We are **NOT LIABLE** for any financial losses, damages, or expenses resulting from:
- **Incorrect currency conversions** or exchange rate errors
- **Inaccurate budget calculations** or expense tracking errors
- **AI-generated financial advice** or recommendations
- **Wrong budgeting suggestions** or overspending based on App projections
- **Errors in expense reports** or analytics

### 9.2 No Liability for Travel Issues
We are **NOT LIABLE** for:
- **Inaccurate AI travel advice** or outdated recommendations
- **Missed flights, bookings, or reservations** based on App information
- **Wrong travel advice** regarding visas, health requirements, or safety
- **Travel disruptions** due to reliance on AI suggestions
- **Personal injury or property damage** during travel

### 9.3 No Liability for Data Loss
We are **NOT LIABLE** for:
- Loss of data due to technical failures, bugs, or security breaches
- Inability to access your account or data
- Errors in data synchronization or backup

### 9.4 Maximum Liability Cap
In no event shall our total liability to you for all claims arising from or related to the App exceed:
- The amount you paid us in the 12 months preceding the claim, **OR**
- $100 USD, whichever is greater

### 9.5 Exclusion of Damages
**WE ARE NOT LIABLE FOR:**
...
- **Currency switching** and multi-currency support
- **More daily travel tips and insights**
- **Priority customer support**
- **Ad-free experience** (if applicable)

### 10.2 Payment Terms
- Subscriptions are billed in advance on a recurring basis (monthly or annually)
- Payment is processed through third-party payment providers (Apple App Store, Google Play)
- Prices are subject to change with advance notice
- You authorize us to charge your payment method automatically for each billing cycle
...
- Creating multiple accounts to abuse free trials is prohibited

---

## 11. Account Rules and Termination
...
- Access to premium features will cease immediately
- No refunds will be issued for remaining subscription time (except as required by law)

### 11.2 Our Right to Terminate
We reserve the right to suspend or terminate your account if:
- You violate these Terms of Service
- You engage in fraudulent, abusive, or illegal activity
- You attempt to reverse engineer or exploit the App
...
- Sections of these Terms that by their nature should survive (liability limitations, dispute resolution) will remain in effect
...
You agree to install updates to continue using the App. Older versions may stop working.
...
**If you do not agree to modified Terms, you must stop using the App and delete your account.**

### 12.3 Feature Changes
We reserve the right to:
- Add, modify, or discontinue features at any time
- Change subscription pricing with advance notice (existing subscribers typically grandfathered for a period)
...
**Jurisdiction**: For any disputes not subject to arbitration, you agree to submit to the exclusive jurisdiction of courts in [JURISDICTION].

### 14.3 Class Action Waiver
To the extent permitted by law, you agree to resolve disputes on an individual basis and waive the right to participate in class actions or class-wide arbitration.

### 14.4 Exceptions
Nothing in this section limits your rights as a consumer under mandatory local laws (e.g., EU consumer protection laws).
...
### 15.5 Force Majeure
We are not liable for any failure or delay in performance due to circumstances beyond our reasonable control (natural disasters, pandemics, war, government actions, etc.).
...
**Response Time**: We aim to respond within 48 hours for general inquiries, sooner for urgent matters.
...
3. You understand the limitations and disclaimers regarding AI-generated content
