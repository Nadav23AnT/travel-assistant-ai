...
- FAQ
- Data handling in support conversations

---

### [Privacy Policy](privacy_policy.md)
Understand how we collect, use, protect, and share your personal information.

**Topics Covered:**
- What data we collect and why
- How we use your information
- Third-party services and data sharing
- Your privacy rights (access, deletion, export)
...
**Privacy Concerns?**
- [Your Privacy Rights](privacy_policy.md#your-rights-and-choices)
- [How to Delete Your Account](privacy_policy.md#deletion-right-to-be-forgotten)
- [How to Export Your Data](privacy_policy.md#access-and-portability)

**Account Issues?**
- [Account Rules](terms_of_service.md#account-rules-and-termination)
- [Subscription Management](terms_of_service.md#premium-features-and-subscriptions)
- [Acceptable Use Policy](terms_of_service.md#prohibited-activities)
...
These legal documents may be updated from time to time. When material changes occur, we will notify you through:
